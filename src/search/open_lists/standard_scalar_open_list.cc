...
public:
    explicit StandardScalarOpenList(const plugins::Options &opts);
...
template<class Entry>
StandardScalarOpenList<Entry>::StandardScalarOpenList(const plugins::Options &opts)
...
class StandardScalarOpenListFeature : public plugins::TypedFeature<OpenListFactory, StandardScalarOpenListFactory> {
public:
    StandardScalarOpenListFeature() : TypedFeature("standard_scalar_open_list") {
        document_synopsis(
            "Standard open list. "
...
static plugins::FeaturePlugin<StandardScalarOpenListFeature> _plugin;
}
