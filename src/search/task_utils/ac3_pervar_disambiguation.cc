...
bool AC3PerVarDisambiguation::test_disambiguate(const CartesianState &partial_state, const MutexInformation &mutexes, int mutex_var, const std::set<int> &values_for_var) const {
