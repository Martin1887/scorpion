...
vector <CartesianHeuristicFunction> AdditiveCartesianHeuristic::generate_heuristic_functions(
    ...
    CostSaturation cost_saturation(
        ...
        opts.get<double>("max_abstractions_time"),
...
void AdditiveCartesianHeuristic::initialize(const plugins::Options &opts) {
...
public:
    ...
    virtual std::shared_ptr<AdditiveCartesianHeuristic> create_component(
        const plugins::Options &options, const utils::Context &) const {
        auto h = make_shared<AdditiveCartesianHeuristic>(options);
