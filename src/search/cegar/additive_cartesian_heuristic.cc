...
namespace cegar {
    ...
    void AdditiveCartesianHeuristic::initialize(const options::Options &opts) {
    ...
    static shared_ptr < Heuristic > _parse(OptionParser & parser) {
        ...
        shared_ptr < AdditiveCartesianHeuristic > h = make_shared < AdditiveCartesianHeuristic > (opts);
        h->initialize(opts);
        return h;
    }
