...
MutexInformation UnsolvableTask::mutex_information() const {
    return MutexInformation();
}
...
bool UnsolvableTask::does_convert_ancestor_state_values(const AbstractTask *) const {
    return false;
}
}
