...
public:
    UnsolvableTask() = default;
    virtual ~UnsolvableTask() override = default;
    ...
    virtual int convert_operator_index(int index, const AbstractTask *ancestor_task) const override;
    ...
    virtual void convert_ancestor_state_values(std::vector<int> &values, const AbstractTask *ancestor_task) const override;
    virtual bool does_convert_ancestor_state_values(const AbstractTask *ancestor_task) const override;
};
}
