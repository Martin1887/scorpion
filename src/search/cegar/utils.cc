...
static void add_pick_flawed_abstract_state_strategies(options::OptionParser &parser) {
    parser.add_enum_option<cegar::PickFlawedAbstractState>(
        ...
        {"FIRST", "FIRST_ON_SHORTEST_PATH", "FIRST_ON_SHORTEST_PATH_UNWANTED_VALUES",
         ...
         "SEQUENCE", "SEQUENCE_IN_ABSTRACTION",
         "SEQUENCE_BACKWARD", "SEQUENCE_IN_ABSTRACTION_BACKWARD",
         "SEQUENCE_BIDIRECTIONAL", "SEQUENCE_IN_ABSTRACTION_BIDIRECTIONAL",
...
static void add_pick_split_strategies(options::OptionParser &parser) {
    ...
    {"RANDOM", "MIN_UNWANTED", "MAX_UNWANTED", "MIN_REFINED", "MAX_REFINED",
     ...
     "HIGHEST_COST_OPERATOR", "LOWEST_COST_OPERATOR",
     "RANDOM_VARS_ORDER",
     "GOAL_DISTANCE_INCREASED", "OPTIMAL_PLAN_COST_INCREASED",
