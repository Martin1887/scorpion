...
CartesianAbstractionGenerator::CartesianAbstractionGenerator(
    ...
    : AbstractionGenerator(opts),
      ...
      operators_disambiguation(opts.get<shared_ptr<disambiguation::DisambiguationMethod>>("operators_disambiguation")),
      abstract_space_disambiguation(opts.get<shared_ptr<disambiguation::DisambiguationMethod>>("abstract_space_disambiguation")),
      transitions_disambiguation(opts.get<shared_ptr<disambiguation::DisambiguationMethod>>("transitions_disambiguation")),
...
unique_ptr<cartesian_abstractions::Abstraction> CartesianAbstractionGenerator::build_abstraction_for_subtask(
    ...
    cartesian_abstractions::CEGAR cegar(
        ...
        subtask.remove_spurious_transitions,
        subtask.refine_init,
        subtask.refine_goals,
        lp_solver,
        abstract_space_disambiguation,
        transitions_disambiguation,
        operators,
        *rng,
        log,
        dot_graph_verbosity);
